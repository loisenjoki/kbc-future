 ...
 */
public class CustomListViewAdapter extends ArrayAdapter<ProductsData> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ProductsData rowItem = getItem(position);

        LayoutInflater mInflater = (LayoutInflater) context
                .getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.morenews_items, null);
        ...
        holder.txtTitle.setText(rowItem.getMoreData());
